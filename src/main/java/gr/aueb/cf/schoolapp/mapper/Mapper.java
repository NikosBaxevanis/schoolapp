...
public class Mapper {
    ...
    public static Teacher mapTeacherInsertToModel(TeacherInsertDTO dto) {
        return new Teacher(null, dto.getFirstname(), dto.getLastname(),dto.getVat(), dto.getFathername(), dto.getPhoneNum(), dto.getEmail(), dto.getStreet(),
    ...
    public static Teacher mapTeacherUpdateToModel(TeacherUpdateDTO dto) {
        return new Teacher(dto.getId(), dto.getFirstname(), dto.getLastname(),dto.getVat(), dto.getFathername(), dto.getPhoneNum(), dto.getEmail(), dto.getStreet(),
                dto.getStreetNum(), dto.getZipCode(), dto.getCityId(), null,null,null);
    }
